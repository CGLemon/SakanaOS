...
typedef enum {
    GDT_NULL_SELEKTOR = 0,      // Reserved segment (Offset 0x00)
...
void gdt_init_descriptor(gdt_selector_t selector,
...
//     kernel mode: 0
//       user mode: 3
uint32_t gdt_get_selector_value(gdt_selector_t selector, uint32_t privilege_level);
